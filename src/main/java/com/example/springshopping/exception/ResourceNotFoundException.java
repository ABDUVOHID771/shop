...
public class ResourceNotFoundException extends BaseException {
  ...
  public ResourceNotFoundException(String message) {
    super(String.format("Resource with %s was not found", message));
  }
  ...
  public ResourceNotFoundException(Class resourceType, UUID resourceUuid) {
    super(
        String.format(
            ...
            resourceType.getCanonicalName(), resourceUuid));
  }

  public ResourceNotFoundException(Class resourceType, String propertyName, String propertyValue) {
    super(
        String.format(
            "Resource (%s) with %s = %s was not found",
            resourceType.getCanonicalName(), propertyName, propertyValue));
  }
}
